...
telegram_app.add_handler(CommandHandler("cpf", cpf))
telegram_app.add_handler(CommandHandler("ajuda", ajuda))
telegram_app.add_handler(CommandHandler("consulta", consulta))
telegram_app.add_handler(CommandHandler("exames", exames))
telegram_app.add_handler(CommandHandler("resultado", resultado))
telegram_app.add_handler(CommandHandler("unidades", unidades))
telegram_app.add_handler(CommandHandler("especialista", especialista))
telegram_app.add_handler(CommandHandler("minhasconsultas", minhasconsultas))
telegram_app.add_handler(MessageHandler(filters.TEXT & ~filters.COMMAND, nlp_resposta))
...
def index():
    return "SUSi está ativo e pronto para atender!"
